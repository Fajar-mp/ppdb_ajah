  ...
  <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <br>
            <h2 class="page-title">Dashboard | Data Siswa </h2>
            
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Data Siswa v1</li>
              </ol>
            </nav>
          </div>
                      ...
                      ?>
                        <tbody style="background-color:white;">
                          ...
                          <td style="text-align: center;">
                            ...
                            <a title="hapus" class="btn btn-danger mdi mdi-delete" style="font-size: 20px;" href="proses/pros_hapus_siswa.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>&nbsp;
                          </td>
                        </tbody>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        name="jurusan" id="country" required="">
                                            ...
                                            <option <?php if ( $row['jurusan'] == 'AKUNTANSI DAN KEUANGAN LEMBAGA') echo 'selected'; ?>>AKUNTANSI DAN KEUANGAN LEMBAGA</option>
                                            ...
                                            <option <?php if ( $row['jurusan'] == 'BISNIS DARING DAN PEMASARAN') echo 'selected'; ?>>BISNIS DARING DAN PEMASARAN</option>
                                        </select>
                                        <div class="invalid-feedback">
